	 <div class="header-top">
		 <!--container-->
		  <div class="container">
			 <div class="top-nav">
						<div class="logo">
						<a href="#"><img src="images/tour.png" id="section-1" class="img-responsive" alt=""/></a>
						</div>
						<div class="menu">
						<ul id="nav">
							 ...
							 <li><a href="admin/loginform.php"   onclick="javascript:window.open('admin/loginform.php','_self')">Login</a></li>                          
